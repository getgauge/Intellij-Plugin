...
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.ARG;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.ARG_END;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.ARG_START;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.COMMENT;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.CONCEPT_HEADING;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.CONCEPT_HEADING_IDENTIFIER;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.DYNAMIC_ARG;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.DYNAMIC_ARG_END;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.DYNAMIC_ARG_START;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.NEW_LINE;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.STEP;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.STEP_IDENTIFIER;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.TABLE_BORDER;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.TABLE_HEADER;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.TABLE_ROW_VALUE;
import static com.thoughtworks.gauge.language.token.ConceptTokenTypes.WHITESPACE;
