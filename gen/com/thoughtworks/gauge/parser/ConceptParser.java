...
public class ConceptParser implements PsiParser {
  ...
  private static boolean concept_0(PsiBuilder b, int l) {
    ...
    while (true) {
      if (!concept_0_0(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "concept_0", c)) break;
  ...
  // (comment)
  private static boolean concept_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "concept_0_0")) return false;
    boolean r;
  ...
  static boolean conceptFile(PsiBuilder b, int l) {
    ...
    while (r) {
      ...
      if (!empty_element_parsed_guard_(b, "conceptFile", c)) break;
      c = current_position_(b);
    }
    exit_section_(b, m, null, r);
    return r;
